...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Lilacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"lilacointools.com", "dnsseed.litecointools.com"},
    {"lilacoinpool.org", "dnsseed.litecoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"lilacointools.com", "testnet-seed.litecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Lilacoin is probably already running."), addrBind.ToString().c_str());
        else
