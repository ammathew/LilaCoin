...
{
    const char* pszTimestamp = "dem wins in PA";
    const CScript genesisOutputScript = CScript() << ParseHex("04f5f07048f26c7db852e072cc494a2901b0258f681b2cef0da35fcd41dfc8b7ef975db066e894932330ee38db618def9c051f4122e4baaeaf9324f073b661a752") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1521036674, 2084666768, 0x1e0ffff0, 1, 25 * COIN);
	...
	assert(consensus.hashGenesisBlock == uint256S("0x6be693e83587222c2539dbe9402960dc65797e6c7a6ce6e82b36c50fb81ceae7"));
        assert(genesis.hashMerkleRoot == uint256S("0xf4a26aeb87ad3a972d3723f098e1dce4be01eb2a11d8c3c078cf62321a8e449bLilas-MBP"));
        ...
        checkpointData = (CCheckpointData) {
            {
                {  0, uint256S("0x6be693e83587222c2539dbe9402960dc65797e6c7a6ce6e82b36c50fb81ceae7")},
        ...
        chainTxData = ChainTxData{
            ...
            1521036674, // * UNIX timestamp of last known number of transactions
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1521036674, 2084666768, 0x207fffff, 1, 25 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
	...
	//    assert(genesis.hashMerkleRoot == uint256S("0x"));
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("6be693e83587222c2539dbe9402960dc65797e6c7a6ce6e82b36c50fb81ceae7")},
            }
        };
